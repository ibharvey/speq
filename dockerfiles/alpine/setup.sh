...
docker build --iidfile iid.tmp -f ${1}/dockerfiles/alpine/cmake.dkr -t alpine:seqan3 ${1}
...
docker build --iidfile iid.tmp -f ${1}/dockerfiles/alpine/install.dkr -t speq ${1}
